...
public class Block {
    ...
    public static void init() {
        ...
        LinkedTreeMap<String, String> blockStates = GSON.fromJson(
                new InputStreamReader(Objects.requireNonNull(Block.class.getClassLoader().getResourceAsStream("mapping/blockstates.json")), StandardCharsets.UTF_8),
                LinkedTreeMap.class
        );
        ...
        LinkedTreeMap<String, String> legacyBlocks = GSON.fromJson(
                new InputStreamReader(Objects.requireNonNull(Block.class.getClassLoader().getResourceAsStream("mapping/legacyblocks.json")), StandardCharsets.UTF_8),
                LinkedTreeMap.class
        );
        ...
        LinkedTreeMap<String, LinkedTreeMap<String, String>> modernMap = GSON.fromJson(
                new InputStreamReader(Objects.requireNonNull(Block.class.getClassLoader().getResourceAsStream("mapping/blockstates_mapping.json")), StandardCharsets.UTF_8),
                LinkedTreeMap.class
        );
